...
export const AI_GATEWAY_ENABLED =
  AI_ACTIVE_TEXT_GENERATION_PROVIDER === 'gateway';
export const AI_GATEWAY_ACTIVE_MODEL =
  AI_GATEWAY_ENABLED ? AI_GATEWAY_MODEL : undefined;
...
export const APP_CONFIGURATION = {
  ...
  aiGatewayActiveModel: AI_GATEWAY_ACTIVE_MODEL,
