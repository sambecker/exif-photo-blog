...
- `NEXT_PUBLIC_GEO_PRIVACY = 1` disables collection/display of location-based data (⚠️ modifies original images in subtle ways in order to remove identifying information)
